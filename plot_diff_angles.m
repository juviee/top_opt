...
%     generic_filename = "1 isotropic_sol";
...
%     fprintf(file_id, "u isotropic = %g\n", u_alpha_iso);
    angle = 34 * pi / 180;
    generic_filename = sprintf("min-angle34");
    u_alpha_34 = top_comp(vfc_fiber, E_fiber, E_mx, mu_mx, mu_mx, ...
                         angle, force, generic_filename)
    angle = 123 * pi / 180;
    generic_filename = sprintf("max-angle123");
    u_alpha_123 = top_comp(vfc_fiber, E_fiber, E_mx, mu_mx, mu_mx, ...
                         angle, force, generic_filename)
%    fprintf(file_id, "u 34 = %g\n", u_alpha_0);
% 
%     generic_filename = sprintf("3 angle_22_5 vfc_fib_%0.2f x_%.0f y_%.0f", ...
...
% 
%     generic_filename = sprintf("4 angle_%3d vfc_fib_%0.2f x_%.0f y_%.0f", ...
...
%     generic_filename = sprintf("5 angle_%3d vfc_fib_%0.2f x_%.0f y_%.0f", ...
